...
Q44 и Q45 плана T1.5 закрыты владельцем. Оценки не проверены реализацией.
...
известному `finding_id` в T1.5 не входит: его механически связывает T1.7b после
проверки finding/периода в T1.6 (Q45).
...
адаптер T1.5; `new_observations` не могут использовать этот direct path.
