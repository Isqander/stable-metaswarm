...
вместе с отбором и spawn: там же, где известно, какую ревизию агенту передают.
T1.3 даёт примитивы — запись попытки с `subject_revision` и
...
правок» и негативный AC на произвольное значение.
