...
решение. Читать обязательно: там тридцать четыре уточнения с обоснованием,
...
Проектирование и последующее ревью таск-планов дали тридцать четыре уточнения:
тридцать два обязательных изменения, одну возможность (пункт 5) и один явный
пересмотр решения (пункт 30). Пункты 1–29 и 31–34 не отменяют принятых решений —
