...
ограничений таблиц отчёт отдельно показывает **132 нормативных / 109 покрытых /
...
решение. Читать обязательно: там тридцать уточнений с обоснованием,
...
Проектирование и последующее ревью таск-планов дали тридцать уточнений:
двадцать восемь обязательных изменений, одну возможность (пункт 5) и один
явный пересмотр решения (пункт 30). Пункты 1–29 не отменяют принятых решений —
