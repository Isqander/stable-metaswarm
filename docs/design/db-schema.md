...
решение. Читать обязательно: там десять уточнений с обоснованием, включая одну
...
Проектирование схемы обнаружило одиннадцать мест, где решение чего-то не учло,
и одну возможность (пункт 5). Ни одно из
...
Пункты 1–4 и 6–10 **перенесены в `decision.md`** и живут там как принятые
